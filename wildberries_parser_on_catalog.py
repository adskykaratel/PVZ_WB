...
"""
ОБНОВЛЕН: на 20.07.2024 работает исправно!
...
if __name__ == '__main__':
    ...
    while True:
        try:
            print('По вопросу парсинга Wildberries, отзывам и предложениям пишите в тг @Zuuuzuuu1')
            print('Заказать разработку парсера Вайлдберрис: тг @Zuuuzuuu1')
